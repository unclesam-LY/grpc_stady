...
const file_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x12A\n" +
	"\bSayHello\x12\x18.grpc_proto.HelloRequest\x1a\x19.grpc_proto.HelloResponse\"\x00B\rZ\v/hello_grpcb\x06proto3"
...
var file_hello_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: grpc_proto.HelloRequest
	(*HelloResponse)(nil), // 1: grpc_proto.HelloResponse
}
var file_hello_proto_depIdxs = []int32{
	0, // 0: grpc_proto.HelloService.SayHello:input_type -> grpc_proto.HelloRequest
	1, // 1: grpc_proto.HelloService.SayHello:output_type -> grpc_proto.HelloResponse
